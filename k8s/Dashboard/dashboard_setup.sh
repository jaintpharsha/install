...
if [[ "$1" == 'install' ]]; then
    ...
    kubectl create secret generic kubernetes-dashboard-certs --from-file=$HOME/certs -n kubernetes-dashboard && kubectl apply -f https://raw.githubusercontent.com/jaintpharsha/install/main/k8s/Dashboard/kubernete-dashboard.yml
    
    echo -e "\n   DASHBOARD_ENDPOINT: https://<any_worker_node_ip>:32000"
